<?php
/**
 * /vkljuchenie-v-reestr-minpromtorga/city-template.php
 * Шаблон для создания городских страниц
 */
                ...
                <div class="custom-process-steps">
                    ...
                    <div class="custom-process-step">
                        ...
                        <div class="custom-step-content">
                            ...
                            <p>Подача заявления в <a href="/gisp-minpromtorg" title="ГИСП Минпромторга">систему ГИСП Минпромторга</a> с полным пакетом документов</p>
                        </div>
                    </div>
                    <div class="custom-process-step">
